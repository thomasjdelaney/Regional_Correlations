"""
For saving the firing rates at different bin widths. It's pretty much the same, as you would expect.
"""
...
parser = argparse.ArgumentParser(description='For saving the firing rates at different bin widths.')
