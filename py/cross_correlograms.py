...
parser.add_argument('-i', '--stim_id', help='The id of the stimulus condition to use.')
...
def main():
    ...
    for pair in responding_pairs:
        ...
        filepath = plotWithStdErrors(correlations, corr_std_errors, delays, "Correlation Coefficient (a.u.)", pair, region, stim_id)
